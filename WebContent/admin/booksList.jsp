...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<%=basePath%>/admin/ManagerServlet?op=category">书籍分类</a>
		</div>
		...
		<table class="table table-bordered table-hover" style="width: 100%">
			...
			<c:forEach items="${books}" var="s" varStatus="vs">
				<tr class="active">
					...
					<td><a
						href="<%=basePath%>/admin/ManagerServlet?op=editBookUI&book_id=${s.book_id}">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a
						href="<%=basePath%>/admin/ManagerServlet?op=delBook&book_id=${s.book_id}"
